...
class ParkwayFaceTechServiceTest extends TestCase
{
    ...
    {
        $recognitionService = FaceTech::getFacialRecognitionService();
        ...
        FaceTech::enroll($user, new ImageFile(base_path('images/1.png')));
        $this->assertDatabaseCount('examples', 1);
        $user->refresh();

        //
        FaceTech::addSecondaryExample($user, new ImageFile(base_path('images/1.png')));
